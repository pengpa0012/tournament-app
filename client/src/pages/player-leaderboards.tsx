  ...
  return <>
    {
      playerLeaderboardsContent.map((item, i) => (
        <div key={i} className="border-2 border-r-0 border-t-0 border-l-0 p-4 flex items-center justify-between hover:bg-gray-200 cursor-pointer"  onClick={() => router.push(`/profile?id=${item.name}`)}>
